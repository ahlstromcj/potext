...
\title{Potext Developer Guide 0.3.0}
\author{Chris Ahlstrom \\
...
\label{sec:introduction}
   ...
   and above.
   It support builds using the \textsl{GNU} and \textsl{Clang} compilers.
   It support cross-builds using the \textsl{MingW} toolset.
   It also requires the use of \textsl{Meson 1.4} and above.
