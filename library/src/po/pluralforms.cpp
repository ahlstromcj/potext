...
/**
 *  One plural form: Plural-Forms: nplurals=2; plural=n != 1;
 *
 *      English, German, Dutch, Swedish, Danish, Norwegian, and many more.
 */
...
plural2_mk_2 (int n)
{
    return static_cast<unsigned>((n % 10 == 1 && n % 100 != 11) ? 0 : 1);
}
...
plural3_ga (int n)
{
    return static_cast<unsigned>(n == 1 ? 0 : n == 2 ? 1 : 2);
}
...
plural3_sk (int n)
{
    return static_cast<unsigned>((n == 1) ? 0 : (n >= 2 && n <= 4) ? 1 : 2 );
}
...
plural3_sl (int n)
{
    ...
    (
        n % 100 == 1 ?
            0 : n % 100 == 2 ?  1 : n % 100 == 3 || n % 100 == 4 ?  2 : 3
    );
}
